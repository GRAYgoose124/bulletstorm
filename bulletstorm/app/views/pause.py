...
class PauseView(arcade.View):
    ...
    def __build_pause_screen(self):
        ...
        pause_title = arcade.gui.UITextArea(text="Paused", font_size=20, font_name="Arial", color=arcade.color.GRAY_BLUE)
        ...
        resume_button = arcade.gui.UIAnchorWidget(child=resume_button, anchor_x="center", anchor_y="center")
        ...
        settings_button = arcade.gui.UIAnchorWidget(child=settings_button, anchor_x="center", anchor_y="center", align_y=-55)

        quit_button = arcade.gui.UIFlatButton(text="Quit", width=200, height=50)
        quit_button.on_click = lambda _: arcade.close_window()
        quit_button = arcade.gui.UIAnchorWidget(child=quit_button, anchor_x="center", anchor_y="center", align_y=-110)
        ...
        # build screen
        pause_screen.add(arcade.gui.UIAnchorWidget(child=pause_title, align_x=150, anchor_y="top"))
        pause_screen.add(arcade.gui.UIAnchorWidget(child=pause_buttons, anchor_x="center", anchor_y="center"))

        return pause_screen
    
    def __build_settings_menu(self):
        menu = arcade.gui.UIBoxLayout()
        menu.add(arcade.gui.UITextArea(text="Settings", font_size=20, font_name="Arial", color=arcade.color.WHITE))
        ...
        menu.add(arcade.gui.UIAnchorWidget(child=close_button, anchor_x="center", anchor_y="right"))
